...
} itab[] =
{
	...
	"MOVWD",	LTYPE3, AMOVWD,
	"MOVWF",		LTYPE3, AMOVWF,
	"MOVWDU",	LTYPE3, AMOVWDU,
	"MOVWFU",	LTYPE3, AMOVWFU,
	"MOVDWU",	LTYPE3, AMOVDWU,
	"MOVFWU",	LTYPE3, AMOVFWU,

	"LDREX",		LTYPE3, ALDREX,
	"LDREXB",		LTYPE3, ALDREXB,
	"LDREXD",		LTYPE3, ALDREXD,
	"LDREXH",		LTYPE3, ALDREXH,
	"STREX",		LTYPES, ASTREX,
	"STREXB",		LTYPES, ASTREXB,
	"STREXD",		LTYPES, ASTREXD,
	"STREXH",		LTYPES, ASTREXH,
